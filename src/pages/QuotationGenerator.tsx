...
const QuotationGenerator = () => {
  ...
  const downloadPDF = () => {
    console.log('Starting direct PDF download for quotation');
    ...
    try {
      ...
      link.href = url;
      link.download = `Quotation_${quotationData.quotationNumber}.html`;
      ...
      toast({
        ...
        description: "Quotation file has been downloaded to your device",
      });
